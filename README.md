...
<h1 align="center" style="font-weight: bold;">Totem - Rede Ancora 💻</h1>
...
<p align="center">
    <img src="/src/img/projeto/print-1.png" alt="Imagem do Projeto" width="400px">
    <img src="/src/img/projeto/print-2.png" alt="Imagem do Projeto" width="400px">
</p>

<h2 id="about">📌 Sobre</h2>

O principal objetivo deste projeto é oferecer aos usuários uma experiência de compra online intuitiva e eficiente. Para isso, desenvolvemos uma aplicação web que permite aos usuários buscar e filtrar itens de compra com base no nome ou marca do produto.
...
```bash
git clone https://github.com/owilliangoncalves/totem-ancora.git
```
